...
public class MNG2_GameManager : MonoBehaviour
{
    ...
    {
        //MNG2_SoundManager.instance.PlaySound(TypeSound.Phaohoa);
        GameObject newPhaoHoa = Instantiate(phaohoa, transform.position, Quaternion.identity);
        yield return new WaitForSeconds(2);
        Destroy(newPhaoHoa);
        //MNG2_SoundManager.instance.PlaySound(TypeSound.Goldcoin);
    ...
    IEnumerator DelayThua()
    {
        ...
        //MNG2_SoundManager.instance.PlaySound(TypeSound.DieChar);
        yield return new WaitForSeconds(0.3f);
        if(MNG2_Player.instance.gameObject != null)
            Destroy(MNG2_Player.instance.gameObject);
        yield return new WaitForSeconds(1.5f);
        //MNG2_SoundManager.instance.PlaySound(TypeSound.Youlost);
        lost.SetActive(true);
    }
