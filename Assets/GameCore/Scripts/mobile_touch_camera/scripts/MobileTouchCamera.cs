...
namespace BitBenderGames
{
    ...
    public class MobileTouchCamera : MonoBehaviourWrapped
    {
        ...
        public static float camFollowFactor = 8.0f;
        [SerializeField]
        [Tooltip("Lock cam")]
        public static bool isMoveObject;
        public static bool LockCam;
        public static bool isZoomCam;
        [SerializeField]
        ...
        public void SetTargetPosition(Vector3 newPositionClamped)
        {
        ...
        {
            if (EventSystem.current.IsPointerOverGameObject(0) == false && !LockCam && !isZoomCam || isMoveObject)
            {
                //Zoom.
        ...
        private void InputControllerOnInputClick(Vector3 clickPosition, bool isDoubleClick)
        {
            ...
            //if (GameObject.Find("Scroll View Cay trong") && EventSystem.current.IsPointerOverGameObject() == false)
            //    GameObject.Find("Scroll View Cay trong").SetActive(false);
            //Debug.Log("InputControllerOnInputClick");
