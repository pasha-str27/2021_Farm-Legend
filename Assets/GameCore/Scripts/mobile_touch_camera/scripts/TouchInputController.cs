...
namespace BitBenderGames
{
    ...
    public class TouchInputController : MonoBehaviour
    {
        ...
        public void Update()
        {
            if (Util.IsMouseOverUI || PlayerPrefSave.IsTutorial)
                return;
        ...
        private void StartPinch()
        {
            ...
            if (OnPinchStart != null && !MobileTouchCamera.LockCam)
            {
        ...
        private void UpdatePinch()
        {
            ...
            if (OnPinchUpdate != null && !MobileTouchCamera.LockCam)
            {
        ...
        private void StopPinch()
        {
            ...
            if (OnPinchStop != null && !MobileTouchCamera.LockCam)
            {
                OnPinchStop.Invoke();
            }
        }
        ...
        {
            if (OnDragStart != null && !MobileTouchCamera.LockCam)
            {
                OnDragStart(pos);
            }
            isClickPrevented = true;
        ...
        {
            if (OnDragUpdate != null && !MobileTouchCamera.LockCam)
            {
        ...
        private void DragStop(Vector3 pos)
        {
            ...
            if (OnDragStop != null && !MobileTouchCamera.LockCam)
            {
